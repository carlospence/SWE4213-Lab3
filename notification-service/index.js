            ...
            await channel.consume(QUEUE_NAME, async (msg) => {
                if (msg) {
                    try {
                        ...
                        console.log(`[Notification] Sending confirmation to ${content.patient_email}`);
                        console.log(`  Appointment ID : ${content.appointment_id}`);
                        console.log(`  Doctor         : ${content.doctor_name}`);
